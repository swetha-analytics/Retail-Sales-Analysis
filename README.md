...
📄 Full analysis, findings, and recommendations for all 12 business questions: REPORT.md
...
📊 File: dashboard/Superstore_Sales_Dashboard.pbix
...
How to Reproduce
Import data/Sample-Superstore.csv into MySQL as table sample_superstore
Run the queries in sql/retail_sales_analysis.sql
Open dashboard/Superstore_Sales_Dashboard.pbix in Power BI Desktop to explore interactively
Author

Swetha D GitHub · LinkedIn
